...
IsArmy::IsArmy( const ObservationInterface* obs ) : observation_( obs )
{
...
IsStructure::IsStructure( const ObservationInterface* obs ) : observation_( obs )
{
...
bool MultiplayerBot::TryBuildStructure(AbilityID ability_type_for_structure, UnitTypeID unit_type, Point2D location, bool isExpansion ) {
